...
class Tasks(models.Model):
    ...
    ProjectId=models.ForeignKey(Projects,related_name='tasks', blank=True,on_delete=models.CASCADE)
    ...
    CreateByUserId=models.ForeignKey(Users,related_name='createdTasks', null=True, blank=True, on_delete=models.CASCADE)
    UpdatedDate=models.DateTimeField(auto_now=True,null=True, blank=True)
    UpdatedByUserId=models.ForeignKey(Users,related_name='updatedTasks', null=True, blank=True, on_delete=models.CASCADE)
