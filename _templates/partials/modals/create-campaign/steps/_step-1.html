...
<div class="current" data-kt-stepper-element="content">
	...
	<div class="w-100">
		...
		<div class="fv-row mb-10">
			...
			<style>.image-input-placeholder { background-image: url('{% static "media/svg/files/blank-image.svg" %}'); } [data-theme="dark"] .image-input-placeholder { background-image: url('{% static "media/svg/files/blank-image-dark.svg" %}'); }</style>
