...
urlpatterns = [
    ...
    path('paste_dataset', GenerateData.as_view(template_name = 'pages/dataset/generate_dataset.html'), name='paste_dataset'),
    path('argument_dataset', GenerateData.as_view(template_name = 'pages/dataset/generate_dataset.html'), name='argument_dataset'),
